...
<form  id="nuevo" name="nuevo" method="POST" action="index.php?c=vehiculos&a=actualizar" autocomplete="off">
	...
	fecha_solicita: <input type="date" name="fecha_solicita" id="fecha_solicita" value=" <?php echo $data["vehiculos"] ["fecha_solicita"] ?>"><br>
nombre_responsable:
        <select name="comboPuesto"> 
            <option value="luis"> luis . </option>
            <option value="juan"> juan .  </option>

            <!--input type="text" name="comboPuesto" placeholder="Aclara que puesto"--> 
